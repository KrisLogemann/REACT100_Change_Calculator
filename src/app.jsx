...
class App extends Component {
  ...
  calculate(amountDue, amountReceived) {
    ...
    const totalDollars = Math.trunc(changeDue);
    const twenties = Math.floor(totalDollars / 20);
    const tens = Math.floor((totalDollars % 20) / 10);
    const fives = Math.floor(((totalDollars % 20) % 10) / 5);
    const ones = Math.floor(((totalDollars % 20) % 10) % 5);
              ...
              <div className='panel-body'>
                ...
                <div className='panel-footer'>
                  <button
                    ...
                    className='btn btn-primary form-control'>Calculate</button>
                </div>
              </div>
            </div>
          </div>
